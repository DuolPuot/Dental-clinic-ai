const fs = require('fs');
const content = `import { Types } from 'mongoose';
...
`;
fs.writeFileSync('apps/api/src/services/appointment.service.ts', content, 'utf8');
console.log('Written successfully. Size:', fs.statSync('apps/api/src/services/appointment.service.ts').size, 'bytes');
